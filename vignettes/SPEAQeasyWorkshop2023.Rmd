...
* understand the purpose of [SPEAQeasy](https://github.com/LieberInstitute/SPEAQeasy) and the type of data it produces
* understand techniques used to filter and normalize gene-expression data
* understand how to identify suitable covariates for differential expression analyses

### Learning objectives

* use `r Biocpkg('ggplot2')` to understand bulk RNA-seq quality metrics for the `r Biocpkg('smokingMouse')` dataset stored in `r Biocpkg('SummarizedExperiment')` objects output by the [SPEAQeasy](https://github.com/LieberInstitute/SPEAQeasy) pipeline 
