...
## Participation
**TODO**
Participants are expected to follow us during the theoretical explanations and while presenting R code to create plots and perform analyses so that they can run code in their own computers.  (NOT SURE ABOUT THAT)
...
| Data overview                           | 15m |
| Differential Expression Analysis        | 60m |
...
plot <- ggplot(logcounts_data, aes(x = logcounts)) +
    ...
    theme(plot.margin = unit(c(1.5, 3, 1.5, 3), "cm"))
plot
```
...
DE_one_boxplot <- function (age, DEgene){
  ...
  p <-  ggplot(data=as.data.frame(lognorm_DE), 
          ...
          labs(x = "Group", y = "norm counts - covariates",
              title = DEgene, 
