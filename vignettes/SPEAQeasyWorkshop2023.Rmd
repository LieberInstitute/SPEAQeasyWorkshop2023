...
* Understand what SPEAQeasy is and how to include in a RNA-seq processing workflow
* Become familiar with SPEAQeasy outputs
* Perform a differential expression anlysis with real data after analyzed with SPEAQeasy
...
load(
    here('provisional_data', 'rse_gene_mouse_RNAseq_nic-smo.Rdata'),
    verbose = TRUE
)
